...
\subsection{Chức năng dành cho người gửi}
	\begin{itemize}
		...
		\begin{figure}[H]
			\includegraphics[width=1\textwidth]{/sender/sender_payment_1.png}
			\centering
			\caption{Giao diện chọn những đơn hàng đã giao cần thanh toán}
		\end{figure}
		
		\begin{figure}[H]
			\includegraphics[width=1\textwidth]{/sender/sender_payment_2.png}
			\centering
			\caption{Giao diện chọn phương thức thanh toán}
		\end{figure}
		
		\begin{figure}[H]
			\includegraphics[width=1\textwidth]{/sender/sender_payment_3.png}
			\centering
			\caption{Giao diện xác nhận lại tổng số tiền và phương thức thanh toán}
		\end{figure}
	
		\begin{figure}[H]
			\includegraphics[width=1\textwidth]{/sender/sender_payment_4.png}
			\centering
			\caption{Giao diện hệ thống thanh toán trung gian ZaloPay}
		\end{figure}
	
		\begin{figure}[H]
			\includegraphics[width=1\textwidth]{/sender/sender_notify.png}
			\centering
			\caption{Mail thông báo tình trạng đơn hàng của hệ thống}
		\end{figure}
	\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Xem đơn hàng đang đến lấy}
	\begin{figure}[H]
	...
	\item \textbf{Xem danh sách các kiện hàng trong xe}
	\begin{figure}[H]
...
\begin{itemize}
	...
	\begin{figure}[H]
		...
		\centering
		\caption{Xác nhận nhập hàng trong xe tài xế vào kho}
	\end{figure}
