\section{Front-end}
	\subsection{SPA}
		 ...
		 \begin{figure}[H]
		 	\includegraphics[width=1\textwidth]{/MPA.png}
		 	\centering
		 	\linebreak
		 ...
		 \begin{figure}[H]
		 	\includegraphics[width=1\textwidth]{/SPA.png}
		 	\centering
		 	\linebreak
...
1			\includegraphics[width=1\textwidth]{/cicd.png}
		...
		\subsection{Giám sát lỗi hệ thống bằng dịch vụ Sentry}
			...
			\subsubsection{Áp dụng sentry cho hệ thống giao hàng liên tỉnh}
			 	...
			 	\begin{figure}[H]
			 		\includegraphics[width=1\textwidth]{/sentry/sentry_dashboard.png}
			 		\centering
			 	...
			 	\begin{figure}[H]
			 		\includegraphics[width=1\textwidth]{/sentry/sentry_detail_1.png}
			 		\centering
			 		\caption{Giao diện xem lỗi gửi về chi tiết (Nửa trên màn hình)}
			 	\end{figure}
		 	
		 		\begin{figure}[H]
		 			\includegraphics[width=1\textwidth]{/sentry/sentry_detail_2.png}
		 			\centering
			 	...
			 	\begin{figure}[H]
			 		\includegraphics[width=1\textwidth]{/GA/GA_dashboard_1.png}
			 		\centering
			 		\caption{Giao diện dashboard của Google Analytic (Nửa trên)}
			 	\end{figure}
		 	
		 		\begin{figure}[H]
		 			\includegraphics[width=1\textwidth]{/GA/GA_dashboard_2.png}
		 			\centering
			 		\caption{Giao diện dashboard của Google Analytic (Nửa dưới)}
		 		\end{figure}
			 	
			 	\begin{figure}[H]
			 		\includegraphics[width=1\textwidth]{/GA/GA_overview.png}
			 		\centering
			 		\caption{Màn hình thống kê thời gian thực tổng quan}
			 	\end{figure}
			 	
			 	\begin{figure}[H]
			 		\includegraphics[width=1\textwidth]{/GA/GA_location.png}
			 		\centering
			 		\caption{Màn hình thống kê thời gian thực theo địa lý}
			 	\end{figure}
			 	
			 	\begin{figure}[H]
			 		\includegraphics[width=1\textwidth]{/GA/GA_events.png}
			 		\centering
