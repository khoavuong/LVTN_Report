    	...
    	\begin{itemize}
				\item Đối với người dùng
					\begin{itemize}
				        ...
				        \item Tạo đơn hàng: Lúc tạo đơn hàng người dùng có thể tự đến gửi hàng trực tiếp tại kho hoặc người dùng lựa chọn có tài xế đến lấy, phí vận chuyển có thể là người gửi thanh toán hoặc người nhận thanh toán.
				        ...
				        \item Nhận thông báo: Sau khi đơn hàng được xác nhận bởi tài xế, thì người dùng sẽ liên tục nhận được thông báo mỗi khi chuyển trạng thái của đơn hàng. Điều này giúp cho người dùng có thể theo dõi đơn hàng chặt chẽ và dễ dàng dự báo thời gian nhận hàng của mình.
				...
				\item Đối với thủ kho
			    	\begin{itemize}
			    	    \item Chỉnh sửa thông tin cá nhân thủ kho.
