...
\end{figure}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \textbf{Xem đơn hàng được nhận}: Người nhận có thể nhập số điện thoại để xem các đơn hàng được nhận, các đơn hàng sẽ được chia theo trạng thái đã định nghĩa ở trên và người gửi có thể xem danh sách các đơn hàng lọc theo trạng thái đó. 
...
\newpage
    ...
    \begin{itemize}
    	...
    	\begin{enumerate}
    		...
    		\item \textbf{PENDING (Đang xử lý)}: Đơn hàng có trạng trái đang xử lý nếu tài xế báo cáo sự cố về kiện hàng trong đơn hàng đó.
